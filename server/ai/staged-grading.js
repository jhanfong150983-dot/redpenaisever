...
- For visible=true questions with question_context/group_context, output answerBbox that frames the FULL QUESTION CONTEXT so a teacher can see the entire question at a glance:
  ...
  - For single_choice / true_false: answerBbox must frame ONLY the student's answer area — the parentheses ( ) or bracket where the student writes their answer. Do NOT include the question stem text or option content. This prevents the AI reader from seeing the question and guessing the answer instead of reading.
